...
def main():
    ...
    # Check for scheduling conflicts and display warnings
    if scheduler.check_and_warn_conflicts(time_window_minutes=30):
        print("⚠️  Please review the conflicts above and reschedule tasks if needed.\n")
    else:
